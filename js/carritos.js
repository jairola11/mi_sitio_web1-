...
function imagen1() {
  imgBox.setAttribute("src", ("img/zapatos/image-product-1.jpg")); 
 ...
 function imagen2() {
    imgBox.setAttribute("src", ("img/zapatos/image-product-2.jpg"));
...
function imagen3() {
    imgBox.setAttribute("src", ("img/zapatos/image-product-3.jpg"));
...
function imagen4() {
    imgBox.setAttribute("src", ("img/zapatos/image-product-4.jpg"));
...
function imagBody1() {
  anime();
  imgBoxbody.setAttribute("src", ("img/zapatos/image-product-1.jpg"));
...
function imagBody2() {
  anime();
  imgBoxbody.setAttribute("src", ("img/zapatos/image-product-2.jpg"));
...
function imagBody3() {
  anime();
  imgBoxbody.setAttribute("src", ("img/zapatos/image-product-3.jpg"));
...
function imagBody4() {
  anime();
  imgBoxbody.setAttribute("src", ("img/zapatos/image-product-4.jpg"));
